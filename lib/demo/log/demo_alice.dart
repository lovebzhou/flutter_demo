...
class DemoAlicePage extends StatefulWidget {
  static const String title = 'HTTP Inspector演示';
  @override
  _DemoAlicePageState createState() => _DemoAlicePageState();
}

class _DemoAlicePageState extends State<DemoAlicePage> {
  Alice alice;
  Dio dio;
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: Scaffold(
        appBar: AppBar(
          title: const Text(DemoAlicePage.title),
        ),
        body: Center(
            child:
